<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-10 break-words" @close="hide()">
      ...
      >
        <div
          class="fixed inset-0 bg-second-500 bg-opacity-75 transition-opacity dark:bg-second-900 dark:bg-opacity-75"
        />
      </TransitionChild>
          ...
          >
            ...
            >
              ...
              <div v-if="!hide_close" class="mt-5 sm:mt-6">
                <button
                  type="button"
                  class="inline-flex w-full justify-center rounded-md bg-second-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-second-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-second-600 dark:bg-second-800"
                  @click="hide()"
                >
                  Schließen
                </button>
